...
void remove(void);
typedef enum { 
	HELP, HELPCOMPOSE, HELPDISPLAY, HELPPLAYBACK, HELPRECEIVE, HELPRECORD, HELPSELECT, HELPSETTINGS, HELPREMOVE,
	COMPOSE, DISPLAY, PLAYBACK, RECEIVE, RECORD, SELECT, SETTINGS, REMOVE
}OPTIONS;